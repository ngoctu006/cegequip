jQuery(document).ready(function(){
    ...
    jQuery('#primary-menu li.more').append('<ul class="submenu"><li><a title="'+ arr[arr.length - 2].title+'" href="'+ arr[arr.length - 2].href+'">'+ arr[arr.length - 2].title+'</a></li><li><a title="'+ arr[arr.length - 3].title+'" href="'+ arr[arr.length - 3].href +'">'+ arr[arr.length - 3].title +'</a></li></ul>');
