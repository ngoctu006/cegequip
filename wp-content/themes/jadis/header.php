      ...
      <header class="header">
        <div class="top">
          ...
          <div class="top-block-contact">
            <span class="text-1">Une équipe dynamique à votre service</span><br>
            <span class="phone">04 81 65 31 00</span><br>
            <span class="text-1">Une équipe dynamique à votre service</span>
          </div>
        </div>
        <nav class="main-nav">
